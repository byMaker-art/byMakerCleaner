...
final class AppInfoFetcher {
    ...
    /// Services handler ("Uninstall with byMakerCleaner") to resolve a right-clicked
    ...
    private func loadAppInfo(from url: URL) -> InstalledApp? {
        ...
        // WORKAROUND OCLP: Completely empty image. SF Symbols trigger CoreImage rasterization on size change.
        let icon = NSImage()

...
/// - Auto-opens the Settings pane and reveals byMakerCleaner.app in Finder so users can
...
final class PermissionCoordinator: ObservableObject {
    ...
    /// Open System Settings AND reveal byMakerCleaner.app in Finder so the user can
    ...
    /// Reset byMakerCleaner's TCC entry and re-prime registration. Use when the user
    /// reports byMakerCleaner doesn't appear in the FDA list (typical after Homebrew

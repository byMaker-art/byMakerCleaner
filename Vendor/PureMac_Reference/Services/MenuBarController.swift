...
final class MenuBarController: NSObject, NSPopoverDelegate {
    ...
    override init() {
        ...
        statusItem.autosaveName = "byMakerCleanerSystemMonitor"
        statusItem.isVisible = true

        let interval = UserDefaults.standard.double(forKey: "settings.general.monitorInterval")
        monitor.start(interval: interval > 0 ? interval : 2.0)
